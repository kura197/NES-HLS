...
class PPU{
    ...
    public:
        ...
        bool render(uint8_t* PPU_RAM, uint8_t* SP_RAM, uint6* VRAM, struct SPREG* spreg, uint8_t* CROM);
        ...
        void bg_render(uint8_t line, struct SPREG* spreg, uint8_t* PPU_RAM, uint6* VRAM, uint8_t* CROM);
        void sp_render(uint8_t line, struct SPREG* spreg, uint8_t* PPU_RAM, uint8_t* SP_RAM, uint6* VRAM, uint8_t* CROM);
